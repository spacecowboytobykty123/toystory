...
func main() {
	...
	flag.StringVar(&cfg.db.dsn, "db-dsn", "postgres://oyna:erke2211@localhost/oyna?sslmode=disable", "PostgresSQL DSN")
	...
	flag.StringVar(&cfg.smtp.username, "smtp-username", "1a4c18da7e9445", "SMTP username")
	flag.StringVar(&cfg.smtp.password, "smtp-password", "cfc3eccc70fd94", "SMTP password")
